...
class Engine:
    def __init__(self, timeframe, asset, features, path):
        self.timeframe = timeframe
        self.asset = asset
        self.features = features
        
    def create_candles(self, file_path, output_path, start_time=93000000, end_time=160000000):
        """
    ...
    def read_buffer_data(self, file_path, start_time, end_time):
